...
function meow_schem.min_max_in_cords(x1, y1, z1, x2, y2, z2)
    local min_vec = {math.min(x1, x2), math.min(y1, y2), math.min(z1, z2)}
    local max_vec = {math.max(x1, x2), math.max(y1, y2), math.max(z1, z2)}
